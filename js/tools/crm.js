...
(() => {
  ...
  Atlas.registerRenderer('crm', async function (root, session) {
    await seed();
    ...
    function paintShell() {
      root.innerHTML = `
        <header class="page-head">
          ...
          <div class="page-head__actions">${canCreate ? `<button class="btn btn--primary" id="new">${Atlas.ICONS.plus}Add contact</button>` : ''}</div>
        </header>
